...
public class WishlistThree {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.id("giftcard_2_RecipientName")).sendKeys("");
        driver.findElement(By.id("giftcard_2_RecipientEmail")).sendKeys("ant@gmail.com");
        ...
        if( result.equals("Enter valid recipient name") ) {
